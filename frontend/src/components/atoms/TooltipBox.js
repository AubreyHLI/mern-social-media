...
const TooltipBox = ({Icon, iconStyle, stati, tip, handleOnClick, option, statiHover, isActive}) => {
    return (
        <div onClick={handleOnClick} className={`select-none relative flex items-center cursor-pointer child:transition-all child:ease-in hover-div-span:visible hover-div-span:transition-visibility hover-div-span:duration-100 hover-div-span:delay-[0.9s]
